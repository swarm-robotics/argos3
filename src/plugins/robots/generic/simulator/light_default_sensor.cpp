...
namespace argos {
   ...
   REGISTER_SENSOR(CLightDefaultSensor,
                   ...
                   "1. For swarms <= 1,000 robots, enabling the light sensor (and therefore causing ARGoS to\n"
                   "   update its readings each timestep) unconditionally does not impact performance too\n"
                   "   much. For larger swarms, it can impact performance, and selectively\n"
                   ...
                   "   by only requiring ARGoS to update the readings when they will be used.\n",
